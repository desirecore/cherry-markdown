...
export default {
  ...
  modelEditPreview: 'Редактирование и просмотр',
  modelEditOnly: 'Только редактирование',
  modelPreviewOnly: 'Только просмотр',
  ...
  exportDocxFile: 'Скачать как Word (.docx)',
  exportWordFile: 'Скопировать для Word',
  panel: 'Панель',
  detail: 'Аккордеон',
  ...
  wordCountC: 'C',
  wordCountL: 'L',
  wordCountImg: 'Изображение',
  wordCountCode: 'Код',
  wordCountChinese: 'Китайский',
  wordCountEnglish: 'Русский',
  wordCountNumber: 'Число',
  wordCountSymbol: 'Символ',
